...
function AuthProvider({ children }) {
    _s();
    const [user, setUser] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](getInitialUser);
    ...
    const [notifications, setNotifications] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](getInitialNotifications);
    const [notificationPreferences, setNotificationPreferences] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](getInitialPreferences);
    const [onboardingData, setOnboardingData] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](getInitialOnboarding);
    const [hasCompletedOnboarding, setHasCompletedOnboarding] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
        "AuthProvider.useState": ()=>!!getInitialOnboarding()
    ...
    const loginWithSocial = async (provider)=>{
        ...
        const socialUser = {
            ...
            verified: true,
            provider,
            avatarUrl: isGoogle ? 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80' : 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80'
        };
        saveUser(socialUser);
        addNotification({
    ...
    const quickDemoLogin = (type = 'founder')=>{
        if (type === 'founder') {
            const demoUser = {
                id: 'usr_founder_01',
                name: 'Elena Rostova',
...
_s(AuthProvider, "mz9/szO20Ep+r2xSZn8wphXXjp0=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_15airp0._.js.map