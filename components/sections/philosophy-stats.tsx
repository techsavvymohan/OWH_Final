...
const STATS: StatItem[] = [
  {
    ...
    targetNum: 0,
    decimals: 0,
    unit: 'Cookie-Cutter Templates',
    title: 'Only Means Bespoke Strategy',
    desc: 'Everything we build is designed specifically for your business, your buyers, and your goals — zero generic templates.',
    icon: Target,
    color: 'text-blue-600',
    accentBg: 'bg-blue-50',
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: 's',
    unit: 'Page Load Speed',
    title: 'Way Means High-Speed Velocity',
    desc: 'Your website loads in under 1 second on every phone and laptop, with instant buttons and smooth checkout.',
    icon: Zap,
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: '%',
    unit: 'Complete Online Growth',
    title: 'Online Means Compound Growth',
    desc: 'We grow your Google rankings, social media presence, and ad campaigns together to bring continuous customers.',
    icon: TrendingUp,
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: '%',
    unit: 'Quality Guarantee Target',
    title: 'Our Strict Quality Standard',
    desc: 'We aim for a perfect 100/100 Google speed score across every page, backed by our 90-day free fix guarantee.',
    icon: Award,
