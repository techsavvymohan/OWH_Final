...
const STATS: StatItem[] = [
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: 's',
    unit: 'Edge Latency Target',
    title: 'Way Means High-Speed Velocity',
    desc: 'We optimize toward sub-second page delivery, zero console faults, and seamless checkout journeys.',
    icon: Zap,
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: '%',
    unit: 'Full-Funnel Optimization',
    title: 'Online Means Compound Growth',
    desc: 'We optimize toward sustainable organic search rankings, thought-leadership reach, and high-converting ad pipelines.',
    icon: TrendingUp,
  ...
  },
  {
    ...
    decimals: 0,
    suffixSymbol: '%',
    unit: 'Target Quality Benchmark',
    title: 'Our Relentless Quality Gate',
    desc: 'We benchmark against top-tier Lighthouse scores across Performance, SEO, Best Practices, and Accessibility backed by a 90-day monitored window.',
    icon: Award,
