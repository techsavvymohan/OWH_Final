...
const CORE_SERVICES: CapabilityService[] = [
  ...
  {
    id: 'tech-seo',
    title: 'SEO · GEO · AEO Search & AI Visibility',
    category: 'Grow',
    badge: 'Organic & AI Traffic',
    desc: 'Get your business ranked at the top of Google search and cited by AI engines like ChatGPT and Perplexity when buyers search for your services.',
    features: ['Google & Bing Page 1 Ranking Strategy', 'AI Search Optimization (GEO for ChatGPT/Perplexity)', 'FAQ & Featured Snippet Structure (AEO)'],
    icon: Search,
    accentColor: 'slate',
  },
  {
