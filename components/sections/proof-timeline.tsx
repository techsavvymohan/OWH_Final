...
const PHASES = [
  {
    ...
    dayStart: 1,
    dayEnd: 30,
    title: 'Phase 1: Full-Stack Architecture & Zero-Bug Handover',
    tagline: 'High-performance Next.js 15 engineering & Playwright QA-gated release',
    color: 'blue',
    icon: Code2,
    deliverables: [
      'Discovery, information architecture, Figma design tokens & wireframes',
      'Next.js 15 + React 19 + TypeScript 5.9 server-first implementation',
      'Technical SEO foundation: structured JSON-LD schema, canonicals & sitemaps',
      'Strict Zero-Bug QA matrix: 0 console warnings, 100/100 Core Web Vitals',
      'Edge CDN production deployment with SSL Grade A+ & HSTS security',
    ],
    metric: '100/100 Lighthouse & Zero-Defect Handover SLA',
  },
  {
    id: 2,
    range: 'Days 31–60',
    dayStart: 31,
    dayEnd: 60,
    title: 'Phase 2: B2B Growth Engine Activation & Indexing',
    tagline: 'Programmatic SEO indexing, brand velocity & high-ROAS paid media',
    color: 'emerald',
    icon: Rocket,
    deliverables: [
      'Google Search Console indexing & commercial keyword cluster deployment',
      'Multi-channel social distribution engine (LinkedIn, X, and Instagram)',
      'Google Ads & Meta Ads campaign launch with server-side CAPI pixel tracking',
      'High-converting ad creative suite tailored to core website tokens',
      'Activation of the 30/60/90-day monitored stability warranty window',
    ],
    metric: 'Organic Traffic Influx & Qualified Inquiries Live',
  },
  {
    id: 3,
    range: 'Days 61–90',
    dayStart: 61,
    dayEnd: 90,
    title: 'Phase 3: Conversion Optimization (CRO) & Compound Scale',
    tagline: 'Conversion rate optimization (CRO), search dominance & ROAS maximization',
    color: 'emerald',
    icon: TrendingUp,
    deliverables: [
      'Conversion Rate Optimization (CRO) using heatmaps and user journey analytics',
      'High-authority backlink acquisition & commercial keyword SERP ascent',
      'Ad budget scaling directed into highest-converting customer cohorts (5.12x+ ROAS)',
      'Executive quarterly growth review & roadmap planning',
      'Final SLA stability sign-off with ongoing retainer continuation',
    ],
    metric: 'Compounding Revenue & Predictable Growth Pipeline',
  },
];
