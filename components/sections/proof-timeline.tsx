...
const PHASES = [
  {
    ...
    deliverables: [
      ...
      'Strict Zero-Bug QA matrix: 0 console warnings, 100/100 Core Web Vitals target',
      'Edge CDN production deployment with SSL Grade A+ & HSTS security',
    ],
    metric: 'Target 100/100 Lighthouse & Zero-Defect Handover SLA',
  },
  {
    id: 2,
    range: 'Days 31–60',
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Ad budget scaling directed into highest-converting customer cohorts (optimizing toward target ROAS benchmarks)',
